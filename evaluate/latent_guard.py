import os
import sys
os.chdir("LatentGuard")
sys.path.append("LatentGuard")
...
parser.add_argument('--file_path', type=str, default='test_prompts.txt', help="Path to the unsafe file")
parser.add_argument('--threshold', type=float, default=5.0, help="Threshold value")
